...
class InvoiceView extends GetView<InvoiceController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(controller.invoiceType == AppConstants.invoiceTypeSales
            ? 'sale'.tr
            : 'return_sale'.tr),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Obx(() => controller.selectedItems.isEmpty
            ...
            Obx(() => SizedBox(
              ...
              child: ElevatedButton(
                onPressed: controller.isLoading.value ? null : controller.submitInvoice,
          ...
          return DataRow(cells: [
            ...
            DataCell(
              SizedBox(
                ...
                child: TextField(
                  keyboardType: TextInputType.number,
                  onChanged: (value) => item.quantity.value = double.tryParse(value) ?? 1.0,
                  decoration: InputDecoration(
            ...
            DataCell(
              SizedBox(
                ...
                child: TextField(
                  keyboardType: TextInputType.number,
                  onChanged: (value) => item.price.value = double.tryParse(value) ?? 0.0,
                  decoration: InputDecoration(
            ...
            DataCell(
              SizedBox(
                ...
                child: TextField(
                  keyboardType: TextInputType.number,
                  onChanged: (value) => item.discount.value = double.tryParse(value) ?? 0.0,
                  decoration: InputDecoration(
            ...
            DataCell(
              SizedBox(
                ...
                child: TextField(
                  keyboardType: TextInputType.number,
                  onChanged: (value) => item.vat.value = double.tryParse(value) ?? 0.0,
                  decoration: InputDecoration(
  ...
  Widget _buildPaymentTypeDropdown() {
    return Obx(() => DropdownButtonFormField<int>(
      ...
      items: [
        DropdownMenuItem(value: AppConstants.paymentTypeCash, child: Text('cash'.tr)),
        DropdownMenuItem(value: AppConstants.paymentTypeVisa, child: Text('visa'.tr)),
        DropdownMenuItem(value: AppConstants.paymentTypeDeferred, child: Text('deferred'.tr)),
      ],
  ...
  Widget _buildStatusDropdown() {
    return Obx(() => DropdownButtonFormField<int>(
      ...
      items: [
        DropdownMenuItem(value: AppConstants.statusPaid, child: Text('paid'.tr)),
        DropdownMenuItem(value: AppConstants.statusUnpaid, child: Text('unpaid'.tr)),
        DropdownMenuItem(value: AppConstants.statusPartiallyPaid, child: Text('partially_paid'.tr)),
      ],
